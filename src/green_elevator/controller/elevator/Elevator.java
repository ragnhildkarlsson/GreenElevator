...
public class Elevator implements Runnable {
	...
	/**
	 * Sends stop command, send door open command, sleeps for a while, send close door command
	 */
	...
	/**
	 * Returns the direction that the elevator is ordered to move in. Observe that the Direction therefore does not have
	 * to reflect the current physical movement of the elevator.
	 * 
	 * @return
	 */
